Michigan 2021 Select Race Data from the American Community Survey (2017-2021) at the Block Group level
...
##Processing
ACS data for Michigan was retrieved with a Python script from the Census API.
The block group data is available by county for all counties in Michigan. The script extracted the data for all counties in Michigan. 
