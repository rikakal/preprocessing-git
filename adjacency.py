...
if state_code.upper() == 'PA':
    ...
    precincts['geometry_2d'] = precincts['geometry'].apply(convert_to_2d)
...
with open(output_file_path, 'w') as json_file:
    json.dump(graph_data, json_file, indent=4, default=lambda o: mapping(o) 
              if isinstance(o, (Polygon, MultiPolygon)) else o)
